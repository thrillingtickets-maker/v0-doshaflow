      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          <a
            ...
            className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-primary-foreground text-primary font-medium rounded-full transition-all hover:shadow-lg"
          >
            Join Waitlist
