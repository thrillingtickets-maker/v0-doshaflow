...
export default function RetreatDay9Page() {
  return (
      ...
      <article className="pt-12 pb-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-foreground mb-12">
            ...
            <p>
              But what happened when I got back matters more than the hospital visit itself.
            </p>

            <h2 className="font-serif text-3xl text-foreground mt-12 mb-6"><strong>The conversation that&apos;s still in my head.</strong></h2>
            <p>
            ...
            <h2 className="font-serif text-3xl text-foreground mt-12 mb-6"><strong>The second enema. Day two of the Virechana protocol.</strong></h2>
            <p>
            ...
            <h2 className="font-serif text-3xl text-foreground mt-12 mb-6"><strong>The sound bath I couldn&apos;t surrender to.</strong></h2>
            <p>
            ...
            <h2 className="font-serif text-3xl text-foreground mt-12 mb-6"><strong>What I&apos;ve been running from.</strong></h2>
            <p>
          ...
          <div className="space-y-3">
            <p className="text-muted-foreground">
              <Link href="/blog/ayurveda-for-anxiety" className="text-[#C97F3D] hover:underline">
