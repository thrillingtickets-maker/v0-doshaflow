      ...
      <article className="pt-12 pb-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-foreground mb-12">
            ...
            <p>
              I weighed myself this morning. I have lost a kilo in five days. Not from restriction or exercise. From smaller portions, from rest, from the absence of alcohol and constant stimulation and the eating-because-I&apos;m-anxious pattern. One kilo is not that much. But it is concrete evidence that something about how I have been living is being recalibrated at the most basic level.
            </p>
