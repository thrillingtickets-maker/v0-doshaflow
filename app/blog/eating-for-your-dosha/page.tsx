      ...
      <div style={{ maxWidth: '680px', margin: '0 auto', padding: '48px 24px' }}>
        ...
        <header style={{ marginBottom: '48px' }}>
          ...
          <h1 style={{ fontSize: '36px', fontWeight: 700, color: '#2c1a0e', marginTop: '12px', marginBottom: '16px', lineHeight: 1.2 }}>
            Eating for Your Dosha: A Practical Guide That&apos;s Not a Restriction Diet
          </h1>
        ...
        <article style={{ color: '#2c1a0e', lineHeight: 1.75 }}>
          ...
          <p style={{ marginBottom: '20px' }}>It isn&apos;t a diet. It doesn&apos;t have a list of forbidden foods. It doesn&apos;t require you to count anything, eliminate entire food groups, or replace meals with supplements. It doesn&apos;t have a 21-day program or a before-and-after.</p>
          ...
          <p style={{ marginBottom: '20px' }}>Vata&apos;s qualities are cold, dry, light, and mobile. Everything in the Vata diet aims at the opposite: warmth, moisture, weight, and consistency.</p>
          
          <p style={{ marginBottom: '20px' }}><strong>Eat more:</strong> Cooked grains (oatmeal, basmati rice, quinoa), root vegetables (sweet potato, beets, carrots, squash), cooked lentils and beans (well-spiced to reduce gas), warming soups and stews, healthy fats (ghee, sesame oil, avocado, coconut), warming spices (ginger, cinnamon, cumin, cardamom, fennel), warm dairy if tolerated, cooked fruit.</p>
          ...
          <p style={{ marginBottom: '20px' }}>Pitta&apos;s qualities are hot, sharp, and penetrating. The diet aims at cooling and softening.</p>
          
          <p style={{ marginBottom: '20px' }}><strong>Eat more:</strong> Sweet, juicy fruits (mangoes, pears, melon, grapes, pomegranate), cooling vegetables (cucumber, zucchini, leafy greens, cilantro, mint), cooked grains (basmati rice, barley, oats), legumes, coconut and coconut oil, dairy (ghee, milk, butter — Pitta is the one dosha that genuinely benefits from these), mild spices (coriander, fennel, cardamom, turmeric, mint).</p>
          ...
          <p style={{ marginBottom: '20px' }}>Kapha&apos;s qualities are heavy, slow, cool, and dense. The diet aims to lighten and stimulate.</p>
          
          <p style={{ marginBottom: '20px' }}><strong>Eat more:</strong> Light grains (millet, barley, buckwheat, corn), legumes and beans, most vegetables (cooked or raw — Kapha handles raw better than Vata), spicy and pungent foods, bitter greens, ginger, black pepper, mustard seeds, light fruits (apples, pears, berries, pomegranate), honey (uniquely beneficial for Kapha), small amounts of lighter proteins.</p>
          ...
          <p style={{ marginBottom: '20px' }}><strong>Vata season:</strong> Fall and early winter. Everyone should eat more like a Vata-balancing diet during this period — warmer, more cooked, more grounding.</p>
          
          <p style={{ marginBottom: '20px' }}><strong>Kapha season:</strong> Late winter and spring. As the earth gets heavy and damp, everyone benefits from lighter, more stimulating foods. This is the season to reduce heavy dairy and wheat, eat more greens, and add more spice.</p>
          ...
          <p style={{ marginBottom: '20px' }}><strong>Change the temperature.</strong> This is the smallest move with one of the biggest returns. Switch from cold drinks to warm. Swap cold food for cooked. This single shift does more for digestion than most specific food swaps.</p>
          
          <p style={{ marginBottom: '20px' }}><strong>Add the right spices.</strong> Vata: ginger, cinnamon, cardamom. Pitta: coriander, fennel, turmeric. Kapha: ginger, black pepper, mustard, trikatu. Cooking with dosha-specific spices changes the energetic quality of almost any meal.</p>
          ...
          <p style={{ marginBottom: '20px' }}>By day four, something had shifted. My digestion was smoother than it had been in years. I wasn&apos;t bloating after meals. My energy was even — not the spikes and crashes I&apos;d normalized. I was sleeping deeply and waking actually rested.</p>
