      ...
      <div style={{ maxWidth: "680px", margin: "0 auto", padding: "48px 24px" }}>
        ...
        <header style={{ marginBottom: "48px" }}>
          ...
          <h1 style={{ fontSize: "36px", fontWeight: 700, color: "#2c1a0e", marginTop: "12px", marginBottom: "16px", lineHeight: 1.2 }}>
            Day 4: The Doctor Told Me to Stop Moving
          </h1>
        ...
        <article style={{ color: "#2c1a0e", lineHeight: 1.75 }}>
          ...
          <p style={{ marginBottom: "20px" }}>Then I met with the doctor.</p>
          
          <p style={{ marginBottom: "20px" }}>I mentioned, casually, that I&apos;d done 15,000 steps. I expected some kind of approval.</p>
          
          <p style={{ marginBottom: "20px" }}>She looked at me like I&apos;d told her I&apos;d been stress-eating.</p>
          
          <p style={{ marginBottom: "20px" }}>&quot;I don&apos;t want you doing 15,000 steps,&quot; she said. &quot;As little as possible. Meditations. Gentle yoga. That&apos;s it.&quot;</p>
          
          <p style={{ marginBottom: "20px" }}>I blinked. &quot;Less movement?&quot;</p>
          
          <p style={{ marginBottom: "20px" }}>&quot;You&apos;re Vata,&quot; she said. And then she explained.</p>
          
          <p style={{ marginBottom: "20px" }}>I already knew I was Vata dominant — high energy, anxious, overthinking, scattered. What I hadn&apos;t internalized was that Vata imbalance is aggravated by exactly the kind of exercise I love most. HIIT. Boot camps. Long power walks. Anything intense, anything that gets the heart pounding. These increase the mobile, scattered quality of Vata — the dosha that&apos;s already too much of all of that in my case.</p>
          
          <p style={{ marginBottom: "20px" }}>What Vata actually needs is the opposite: stillness. Gentle yoga. Meditation. Walking, yes, but slow and grounding, not as a cardio strategy.</p>
          ...
          <p style={{ marginBottom: "20px" }}>Today: no nose drops. They did shirodhara instead — the treatment where warm oil is poured in a slow, continuous stream over the forehead.</p>
          
          <p style={{ marginBottom: "20px" }}>It is very hard to describe what shirodhara feels like to someone who hasn&apos;t had it. The closest I can get: imagine that the part of your brain that generates worry just goes quiet. Not sedated. Quiet. Like the oil is physically displacing the noise. I&apos;ve been trying to reach that state through meditation for years. The oil just did it.</p>
          ...
          <p style={{ marginBottom: "20px" }}>I&apos;ve been here four days and I&apos;ve spent at least eight hours a day on my laptop.</p>
          
          <p style={{ marginBottom: "20px" }}>This is a thing I do. When I take myself out of my normal environment — when I remove alcohol, remove the usual distractions — I find something else to bury myself in. Work, usually. Or I&apos;ll watch Netflix for twelve hours. Anything to avoid just sitting with myself. Being here. Not doing.</p>
          
          <p style={{ marginBottom: "20px" }}>I missed a sound bath today because of a Zoom call. The sound bath was the whole afternoon session.</p>
          ...
          <p style={{ marginBottom: "20px" }}>I&apos;m not going to leave here and become a monk. I&apos;m going to eat sushi again. I&apos;m going to have a steak. I&apos;m not going to be religious about any of this.</p>
          
          <p style={{ marginBottom: "20px" }}>But having a framework — understanding why certain foods speed my brain up and others slow it down, why intense cardio makes my anxiety worse instead of better — that&apos;s actually useful. That goes home with me.</p>
