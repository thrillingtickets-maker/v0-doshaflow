...
export async function generateStaticParams() {
  return [{ slug: "how-to-improve-digestion-naturally" }];
}

export async function generateMetadata() {
  const post = getPostBySlug("how-to-improve-digestion-naturally");
  if (!post) return {};
...
export default async function BlogPostPage() {
  const post = getPostBySlug("how-to-improve-digestion-naturally");
  const highlightWord = highlightMap["how-to-improve-digestion-naturally"];
