...
export const metadata = {
  ...
  description:
    "The complete Kapha diet plan — best foods to stimulate Kapha metabolism, what to avoid, and a practical daily template including the most common Kapha mistakes.",
  openGraph: {
    title: "Kapha Diet Plan: How to Eat for Energy When Your Body Wants to Do Nothing",
    description:
      "The complete Kapha diet plan — best foods to stimulate Kapha metabolism, what to avoid, and a practical daily template including the most common Kapha mistakes.",
    url: "https://www.doshaflow.com/blog/kapha-diet-plan",
    siteName: "DoshaFlow",
    type: "article",
  },
  alternates: {
    canonical: "https://www.doshaflow.com/blog/kapha-diet-plan",
  }
}
        ...
        <article>
          ...
          <div className="prose prose-lg max-w-none text-[#2c2218]" style={{ lineHeight: 1.75 }}>
            ...
            <div style={{ marginTop: "48px", padding: "32px", backgroundColor: "#f5ece0", border: "1px solid #e8d9c5", borderRadius: "16px", textAlign: "center" }}>
              <p style={{ fontSize: "18px", fontWeight: 600, color: "#2c1a0e", marginBottom: "16px" }}>Not sure if you are Kapha?</p>
