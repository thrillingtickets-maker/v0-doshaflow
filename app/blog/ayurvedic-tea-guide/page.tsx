    ...
    <main>
        <article>
          ...
          <div style={{ lineHeight: 1.75 }}>
            ...
            <hr style={{ margin: "40px 0", borderColor: "#e8d9c5" }} />
            <h2 style={{ fontSize: "24px", fontWeight: 700, marginTop: "48px", marginBottom: "16px", color: "#2c1a0e" }}>
              <Link href="/blog/vata-dosha-guide">Vata</Link> Tea: Warming, Grounding, Calming.
            </h2>
            <p style={{ marginBottom: "20px", lineHeight: 1.75 }}>
              <Link href="/blog/vata-dosha-guide" style={{color: "#c49a6c", textDecoration: "underline"}}>Vata</Link> is the dosha of air and ether — cold, dry, light, and mobile. When Vata is elevated: anxiety, irregular digestion, constipation, scattered thinking, insomnia, restlessness. The tea for Vata needs to be warming, heavy, moist, and grounding. <strong>Key herbs:</strong> Ashwagandha is the cornerstone Vata herb — deeply nourishing to the nervous system, clinically shown to reduce cortisol. Takes 4-8 weeks to fully act. Ginger root kindles agni, which Vata types tend to have in an irregular state. Cardamom is warming, digestive, and mildly nervine. Cinnamon and licorice root add warmth and adrenal support. <strong>Best time:</strong> morning and evening 30 minutes before bed. Always warm — never cold. See our guide on <Link href="/blog/best-ayurvedic-tea-anxiety">teas for anxiety</Link> for more detail.
            </p>
            <hr style={{ margin: "40px 0", borderColor: "#e8d9c5" }} />
            <h2 style={{ fontSize: "24px", fontWeight: 700, marginTop: "48px", marginBottom: "16px", color: "#2c1a0e" }}>
              <Link href="/blog/pitta-dosha-guide">Pitta</Link> Tea: Cooling, Calming, Anti-inflammatory.
            </h2>
            <p style={{ marginBottom: "20px", lineHeight: 1.75 }}>
              <Link href="/blog/pitta-dosha-guide" style={{color: "#c49a6c", textDecoration: "underline"}}>Pitta</Link> is the dosha of fire and water — hot, sharp, and intense. When Pitta is elevated: inflammation, skin flares, acid reflux, irritability, heavy periods, headaches. The tea for Pitta needs to cool, not stimulate. <strong>Key herbs:</strong> Shatavari is the primary Pitta-cooling herb, particularly for women — deeply nourishing, hormonally supportive, and cooling. Brahmi cools the mind and supports cognitive function. Rose petal is cooling and anti-inflammatory. Fennel and coriander are cooling digestive herbs that counter the acid reflux Pitta types commonly experience. <strong>Best time:</strong> midday and after meals. Drink warm or slightly cooled — not very hot. Learn more in our guide on <Link href="/blog/best-ayurvedic-tea-anxiety">teas for anxiety</Link>.
            </p>
            
            <hr style={{ margin: "40px 0", borderColor: "#e8d9c5" }} />
            <h2 style={{ fontSize: "24px", fontWeight: 700, marginTop: "48px", marginBottom: "16px", color: "#2c1a0e" }}>
              <Link href="/blog/kapha-dosha-guide">Kapha</Link> Tea: Warming, Stimulating, Moving.
            </h2>
            <p style={{ marginBottom: "20px", lineHeight: 1.75 }}>
              <Link href="/blog/kapha-dosha-guide" style={{color: "#c49a6c", textDecoration: "underline"}}>Kapha</Link> is the dosha of earth and water — heavy, slow, dense, and stable. When Kapha is elevated: weight gain, sluggish digestion, water retention, fatigue that sleep does not fix, emotional flatness. The tea for Kapha needs to be stimulating, light, and heating. <strong>Key herbs:</strong> Trikatu — the three spices of ginger, black pepper, and long pepper — directly stimulates agni and fires up a metabolism that naturally runs slow. Turmeric is anti-inflammatory and metabolically supportive, especially when combined with black pepper. <strong>Best time:</strong> first thing in the morning, before breakfast, before coffee. See our guides on <Link href="/blog/best-ayurvedic-tea-sleep">sleep teas</Link> and <Link href="/blog/best-ayurvedic-tea-digestion">digestion teas</Link> for more options.
            </p>
            <hr style={{ margin: "40px 0", borderColor: "#e8d9c5" }} />
            <h2 style={{ fontSize: "24px", fontWeight: 700, marginTop: "48px", marginBottom: "16px", color: "#2c1a0e" }}>
              Tridoshic Herbs: The Bridge.
            </h2>
            <p style={{ marginBottom: "20px", lineHeight: 1.75 }}>
